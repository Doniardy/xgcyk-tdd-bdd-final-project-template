...
# New tests added below
    ...
    def test_serialize_product(self):
        """It should serialize a Product to a dict"""
        product = ProductFactory()
        product.id = None
        product.create()
        ...
        self.assertEqual(data["price"], str(product.price))  # price serialized as string
    ...
    def test_deserialize_invalid_available_type_raises(self):
        ...
        data = {
            ...
            "description": "desc",
            "price": "19.99",
            "available": "yes",  # invalid, should be bool
            "category": "FOOD"
        }
        product = Product()
        with self.assertRaises(DataValidationError):
    ...
    def test_deserialize_invalid_category_raises(self):
        """It should raise DataValidationError if category is invalid"""
        data = {
            "name": "TestProduct",
            "description": "desc",
            "price": "19.99",
